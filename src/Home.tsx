...
function Home() {
    ...
    async function handleSubmit(ev: FormEvent) {
      ...
      try {
        ...
        setLoadingMessage('');
        window.location.href = 'http://localhost:8080/' + videoResponse.data.videoPath;
      ...
      <main className="max-w-3xl mx-auto flex px-4">
        <div className="py-8 flex flex-col">
          <h1 className="text-4xl font-bold uppercase mb-6">
            URL to Video
            <br />
            <span className="bg-gradient-to-br from-emerald-500 from-30% to-sky-500 bg-clip-text text-transparent"> with power of AI</span>
          </h1>
          <p className="pb-6">
        ...
        <div className="p-8">
          <div className="bg-gray-200 w-[240px] h-[380px] opacity-65 text-center text-black rounded-md">Video Preview..</div>
        </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Our AI-powered tool makes it easy to repurpose your blog content into engaging videos, helping you
                  reach a wider audience and boost your content's impact.
                </p>
              </div>
